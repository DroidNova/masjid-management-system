...
const List<CountryCode> appCountryCodes = <CountryCode>[
  CountryCode(name: 'India', isoCode: 'IN', dialCode: '+91', flagEmoji: '🇮🇳', minLength: 10, maxLength: 10),
  CountryCode(name: 'Saudi Arabia', isoCode: 'SA', dialCode: '+966', flagEmoji: '🇸🇦', minLength: 9, maxLength: 9),
  ...
  CountryCode(name: 'Indonesia', isoCode: 'ID', dialCode: '+62', flagEmoji: '🇮🇩', minLength: 9, maxLength: 12),
